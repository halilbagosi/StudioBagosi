...
// This is now a static portfolio website

// Static gallery sets data (previously from database)
$gallery_sets = [
    [
        'id' => 1,
...
<body>
    ...
    <section id="home" class="hero-section d-flex align-items-center">
        ...
        <div class="container text-center">
            ...
            <a href="#contact" class="btn btn-primary btn-lg">Na Kontaktoni</a>
        </div>
    </section>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card gallery-card">
                        <?php if ($set['has_cover_photo']): ?>
                            <img src="<?php echo $set['cover_image']; ?>" 
                                 class="card-img-top" 
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="contact-info">
                                    <h4>Të Dhënat e Kontaktit</h4>
                                    <p><i class="fas fa-phone"></i> +355 XX XXX XXXX</p>
                                    <p><i class="fas fa-envelope"></i> info@studiobagosi.com</p>
                                    <p><i class="fas fa-map-marker-alt"></i> Tiranë, Shqipëri</p>
                                    
                                    <div class="social-links mt-4">
                                        <h5>Na Ndiqni</h5>
                                        <a href="https://www.facebook.com/share/1AWXLV8FWh/?mibextid=wwXIfr" class="me-3">
                                            <i class="fab fa-facebook fa-2x"></i>
                                        </a>
                                        <a href="https://www.instagram.com/studiobagosi?igsh=MXgzam02Ymk1Zmdvaw==" class="me-3">
                                            <i class="fab fa-instagram fa-2x"></i>
                                        </a>
                                        <a href="https://youtube.com/@studiobagosi?si=foj0IrEr7dpIbCIm">
